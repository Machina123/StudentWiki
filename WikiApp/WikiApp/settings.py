"""
Django settings for WikiApp project.
...
SECRET_KEY = 'f_rub=&y88fmbukob(b1k=sk1+qtxm8kj@dye7tvv&u^^6vv-='
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'translations.context_processor.index',
                'translations.context_processor.files',
...
WSGI_APPLICATION = 'WikiApp.wsgi.application'
...
# dane do poczty bez tego nie będzie wysyłać
